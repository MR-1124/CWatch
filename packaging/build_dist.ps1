...
Write-Host "Publishing C:Watch UI binaries..." -ForegroundColor Yellow
...
# 4. Build GUI Installer Setup.exe
Write-Host "Compiling standalone GUI Setup wizard..." -ForegroundColor Yellow
